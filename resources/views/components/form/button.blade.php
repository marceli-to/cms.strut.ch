...
$variants = [
	'primary' => 'px-5 py-2.5 bg-neutral-900 text-white hover:bg-neutral-800 active:bg-neutral-950',
	'secondary' => 'px-5 py-2.5 bg-transparent text-neutral-900 border border-neutral-300 hover:border-neutral-900 active:bg-neutral-100',
];
@endphp
