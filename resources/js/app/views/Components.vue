...
import Coggle from '../components/icons/Coggle.vue'
import Download from '../components/icons/Download.vue'
import Funnel from '../components/icons/Funnel.vue'
import LinkExternal from '../components/icons/LinkExternal.vue'
...
const colors = [
  ...
  { name: 'snow', hex: '#f5f5f5', bg: 'bg-snow', border: true },
  { name: 'gray', hex: '#828282', bg: 'bg-gray' },
  { name: 'silver', hex: '#c8c8c8', bg: 'bg-silver' },
  { name: 'navy', hex: '#00455c', bg: 'bg-navy' },
  { name: 'slate', hex: '#5a778e', bg: 'bg-slate' },
  { name: 'red', hex: '#dc0000', bg: 'bg-red' },
  { name: 'lime', hex: '#7d9b00', bg: 'bg-lime' },
  { name: 'olive', hex: '#555700', bg: 'bg-olive' },
  { name: 'wine', hex: '#75000a', bg: 'bg-wine' },
  { name: 'bronze', hex: '#8c6900', bg: 'bg-bronze' },
]

const fontSizes = [
  { name: 'text-sm', px: '12px', class: 'text-sm' },
  { name: 'text-md', px: '16px', class: 'text-md' },
  { name: 'text-lg', px: '24px', class: 'text-lg' },
]

const fontWeights = [
  { name: 'font-normal', weight: '400', class: 'font-normal' },
  { name: 'font-medium', weight: '500', class: 'font-medium', pending: true },
  { name: 'font-semibold', weight: '600', class: 'font-semibold' },
]

// Key spacing values (scale goes 0-500, each unit = 1px)
const spacings = [
  { name: '0', px: '0px', class: 'w-0' },
  { name: '4', px: '4px', class: 'w-4' },
  { name: '8', px: '8px', class: 'w-8' },
  { name: '12', px: '12px', class: 'w-12' },
  { name: '16', px: '16px', class: 'w-16' },
  { name: '20', px: '20px', class: 'w-20' },
  { name: '24', px: '24px', class: 'w-24' },
  { name: '32', px: '32px', class: 'w-32' },
  { name: '40', px: '40px', class: 'w-40' },
  { name: '48', px: '48px', class: 'w-48' },
  { name: '64', px: '64px', class: 'w-64' },
  { name: '80', px: '80px', class: 'w-80' },
  { name: '100', px: '100px', class: 'w-100' },
  { name: '128', px: '128px', class: 'w-128' },
  { name: '160', px: '160px', class: 'w-160' },
  { name: '200', px: '200px', class: 'w-200' },
]
</script>
...
<template>
  <div class="min-h-screen bg-white">
    <div class="max-w-6xl mx-auto p-32">
      ...
      <!-- Colors -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Colors</h2>
        <div class="grid grid-cols-12 sm:grid-cols-6 gap-24">
      ...
      <!-- Typography -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Typography</h2>

        <!-- Font Sizes -->
        <h3 class="text-sm font-semibold text-gray mb-12">Sizes</h3>
        <div class="space-y-16 mb-32">
          <div v-for="size in fontSizes" :key="size.name" class="flex items-baseline gap-24">
            <span class="w-80 text-sm text-gray">{{ size.name }}</span>
            <span class="w-48 text-sm text-gray">{{ size.px }}</span>
            <span :class="size.class" class="text-black">The quick brown fox jumps over the lazy dog</span>
          </div>
        </div>

        <!-- Font Weights -->
        <h3 class="text-sm font-semibold text-gray mb-12">Weights</h3>
        <div class="space-y-16">
          <div v-for="weight in fontWeights" :key="weight.name" class="flex items-baseline gap-24">
            <span class="w-112 text-sm text-gray">{{ weight.name }}</span>
            <span class="w-48 text-sm text-gray">{{ weight.weight }}</span>
            <span :class="weight.class" class="text-md text-black">
              The quick brown fox jumps over the lazy dog
              <span v-if="weight.pending" class="text-sm text-gray font-normal ml-8">(pending)</span>
            </span>
          </div>
        </div>
      </section>
      ...
      <!-- Spacing -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Spacing</h2>
        <p class="text-sm text-gray mb-16">Scale: 0-500 (1 unit = 1px). Usage: p-16, m-32, gap-20, w-100, h-64, etc.</p>
        <div class="space-y-8">
          <div v-for="space in spacings" :key="space.name" class="flex items-center gap-16">
            <span class="w-48 text-sm text-gray text-right">{{ space.name }}</span>
            <div class="h-16 bg-navy" :class="space.class"></div>
            <span class="text-sm text-gray">{{ space.px }}</span>
          </div>
        </div>
      </section>
      ...
      <!-- Buttons -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Buttons</h2>
        <div class="flex flex-wrap gap-16">
          <p class="text-sm text-gray">Button variants will be defined here</p>
        </div>
      </section>

      <!-- Form Fields -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Form Fields</h2>
        <div class="grid grid-cols-2 gap-24">
          <p class="text-sm text-gray col-span-2">Form fields will be defined here</p>
        </div>
      </section>

      <!-- Icons -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Icons</h2>

        <!-- Simple Icons -->
        <h3 class="text-sm font-semibold text-gray mb-12">Simple</h3>
        <div class="grid grid-cols-8 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <Avatar class="w-20 h-20 text-black" />
            <span class="text-sm text-gray">Avatar</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Burger class="w-16 h-16 text-black" />
            <span class="text-sm text-gray">Burger</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Cross class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Cross</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Checkmark class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Checkmark</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Coggle class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Coggle</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Download class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Download</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Funnel class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Funnel</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <LinkExternal class="w-16 h-16 text-black" />
            <span class="text-sm text-gray">LinkExternal</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <List class="w-14 h-14 text-black" />
            <span class="text-sm text-gray">List</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Magnifier class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Magnifier</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <PencilCircle class="w-20 h-20 text-black" />
            <span class="text-sm text-gray">PencilCircle</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Plus class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">Plus</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <PlusCircle class="w-20 h-20 text-black" />
            <span class="text-sm text-gray">PlusCircle</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Refresh class="w-14 h-14 text-black" />
            <span class="text-sm text-gray">Refresh</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Window class="w-14 h-14 text-black" />
            <span class="text-sm text-gray">Window</span>
          </div>
        </div>

        <!-- Block Icons -->
        <h3 class="text-sm font-semibold text-gray mb-12">Blocks</h3>
        <div class="grid grid-cols-4 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <BlockText class="w-40 h-32 text-black" />
            <span class="text-sm text-gray">BlockText</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <BlockImage class="w-40 h-32 text-black" />
            <span class="text-sm text-gray">BlockImage</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <BlockGallery class="w-100 h-32 text-black" />
            <span class="text-sm text-gray">BlockGallery</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <BlockLink class="w-40 h-32 text-black" />
            <span class="text-sm text-gray">BlockLink</span>
          </div>
        </div>

        <!-- Arrow variants -->
        <h3 class="text-sm font-semibold text-gray mb-12">Arrow</h3>
        <div class="grid grid-cols-4 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <Arrow variant="right" size="sm" class="w-10 h-10 text-black" />
            <span class="text-sm text-gray">right sm</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Arrow variant="right" size="lg" class="w-16 h-16 text-black" />
            <span class="text-sm text-gray">right lg</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Arrow variant="left" size="sm" class="w-10 h-10 text-black" />
            <span class="text-sm text-gray">left sm</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Arrow variant="left" size="lg" class="w-20 h-20 text-black" />
            <span class="text-sm text-gray">left lg</span>
          </div>
        </div>

        <!-- Chevron variants -->
        <h3 class="text-sm font-semibold text-gray mb-12">Chevron</h3>
        <div class="grid grid-cols-4 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <Chevron variant="down" size="sm" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">down sm</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Chevron variant="down" size="lg" class="w-20 h-20 text-black" />
            <span class="text-sm text-gray">down lg</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Chevron variant="up" size="sm" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">up sm</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Chevron variant="up" size="lg" class="w-20 h-20 text-black" />
            <span class="text-sm text-gray">up lg</span>
          </div>
        </div>

        <!-- Eye variants -->
        <h3 class="text-sm font-semibold text-gray mb-12">Eye</h3>
        <div class="grid grid-cols-4 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <Eye variant="visible" class="w-16 h-16 text-black" />
            <span class="text-sm text-gray">visible</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Eye variant="hidden" class="w-16 h-16 text-black" />
            <span class="text-sm text-gray">hidden</span>
          </div>
        </div>

        <!-- Checkbox variants -->
        <h3 class="text-sm font-semibold text-gray mb-12">Checkbox</h3>
        <div class="grid grid-cols-4 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <Checkbox variant="unchecked" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">unchecked</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Checkbox variant="checked" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">checked</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Checkbox variant="unchecked-thin" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">unchecked-thin</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Checkbox variant="checked-thin" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">checked-thin</span>
          </div>
        </div>

        <!-- Radio variants -->
        <h3 class="text-sm font-semibold text-gray mb-12">Radio</h3>
        <div class="grid grid-cols-4 gap-16 mb-32">
          <div class="flex flex-col items-center gap-8">
            <Radio variant="unchecked" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">unchecked</span>
          </div>
          <div class="flex flex-col items-center gap-8">
            <Radio variant="checked" class="w-12 h-12 text-black" />
            <span class="text-sm text-gray">checked</span>
          </div>
        </div>
      </section>
      ...
      <!-- Layout -->
      <section class="mb-64">
        <h2 class="text-md font-semibold text-black mb-16">Layout</h2>
        <div class="space-y-24">
          <p class="text-sm text-gray">Layout components (nav, header, container) will be defined here</p>
        </div>
      </section>
    </div>
